...
public final class JdbcLatestReviewEventLookupPort implements LatestReviewEventLookupPort {
  ...
  public JdbcLatestReviewEventLookupPort(DataSource dataSource) {
  ...
  public Optional<ReviewEventForCanonicalWrite> findLatestByClaimIdAndOrganizationId(
    ...
    try (Connection connection = dataSource.getConnection();
      ...
      statement.setObject(2, claimId.value());
      ...
      throw new IllegalStateException("Failed to find latest review event by claim id", exception);
    }
  }
