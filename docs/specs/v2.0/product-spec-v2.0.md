<!-- DOCX footer (footer1.xml): AI 猎头交易操作系统 · 完整产品规格书 v2.0 -->
...
![Picture 1](../assets/v2.0/image1.png)

文档类型：完整产品规格书 / UI 设计规划 / AI 权限策略 / 数据模型 / 开发计划
...
| **版本** | **v2.0** |
| **核心升级** | **从“招聘系统”升级为“信息整理 + AI 匹配 + 交易 workflow + 授权披露保护 + 行业包”的完整产品级操作系统。** |
| **UI 设计** | **本规格书内置 7 张高保真 UI 设计图：总览、Owner、Consultant 设计板 A、Consultant 设计板 B、Client、Candidate、Admin。注意：Consultant 始终是一个统一端口，两张图只是为了展示页面数量较多的同一顾问门户。** |
| **设计原则** | **AI-first，但不是 AI-final；AI 能整理、生成、追问、提醒、草拟，关键交易动作必须人工确认。** |
...
![Picture 2](../assets/v2.0/image1.png)

**Owner / Partner 端：界面设计图**

![Picture 3](../assets/v2.0/image2.png)

**Consultant 端设计板 A（同一端口）：Intake 与 Candidate Intelligence**

![Picture 4](../assets/v2.0/image3.png)

**Consultant 端设计板 B（同一端口）：Companies / Jobs / Matching / Workflow**

![Picture 5](../assets/v2.0/image4.png)

**Client 端：界面设计图**

![Picture 6](../assets/v2.0/image5.png)

**Candidate 端：界面设计图**

![Picture 7](../assets/v2.0/image6.png)

**Admin / System 端：界面设计图**

![Picture 8](../assets/v2.0/image7.png)
